                        ...
                        <div class="col-lg-4 col-lg-offset-4">
                            <div class="panel panel-primary" id="panel-header">
                                <div class="panel-heading">
                                    สร้างเงือนไขการจ่ายเงินของลูกค้า เป็นรายปี
                                </div>

                                <div class="panel-body">
                                    <form method='post' action='Create_Customer_Payment_Schedule.php'>
                                        <input type="hidden" name="emp_code" value='<?php echo $user_emp_code;?>;'>

                                        <div class="row">
                                            <div class="col-lg-7">
                                                <label>เลือกปี</label>
                                                <select name='nPaymentYear' id='nPaymentYear' class="form-control">
