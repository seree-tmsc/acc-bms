    ...
    */    
    ...
    try
    {
        ...
        {            
            ...
            $strSql .= "FROM " . "testTRN_AR_" . $_SESSION['ses_cYear'] . $_SESSION['ses_cMonth'] . "  ";
                ...
                while ($ds = $statement->fetch(PDO::FETCH_NAMED))
                {
                    ...
                    switch($_POST['cBillStatus'])
                    {
                        case 'N':
                            ...
                            echo "</a>";
                            */
                            echo "<a href='#' class='reverse_billing_data1' doc_no='" . $ds['internal_billing_no'] . "' data-toggle='tooltip' data-placement='top' title='การคืนค่า-ใบวางบิล'>";
                            echo "<span class='fa fa-undo fa-lg'>" . "&nbsp&nbsp" . "</span>";
                            echo "</a>";
                            
                            echo "<a href='#' class='edit_billing_data1' doc_no='" . $ds['internal_billing_no'] . "' ";
                            echo " amt=" . $ds['AMT'] . " ";
